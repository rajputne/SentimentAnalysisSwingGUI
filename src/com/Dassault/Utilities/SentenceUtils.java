...
public class SentenceUtils {
    ...
    /**
     * Create an ArrayList as a list of {@code TaggedWord} from two lists of
     * {@code String}, one for the words, and the second for the tags.
     *
     * @param lex a list whose items are of type {@code String} and are the
     * words
     * @param tags a list whose items are of type {@code String} and are the
     * tags
     * @return The Sentence
     */
    ...
    /**
     * Create an ArrayList as a list of {@code Word} from a list of
     * {@code String}.
     *
     * @param lex a list whose items are of type {@code String} and are the
     * words
    ...
    /**
     * Create a Sentence as a list of {@code Word} objects from an array of
     * String objects.
     *
    ...
    /**
     * Create a sentence as a List of {@code CoreLabel} objects from an array
     * (or varargs) of String objects.
     *
     * @param words The words to make it from
     * @return The Sentence
     */
    ...
    /**
     * Create a sentence as a List of {@code CoreLabel} objects from a List of
     * other label objects.
     *
     * @param words The words to make it from
     * @return The Sentence
     ...
     * {@code Label}, return just the {@code value()} of the {@code Label} of
     * each word; otherwise, call the {@code toString()} method on each item.
     ...
     * TaggedWord
     *
     * @param separator The string used to separate Word and Tag in TaggedWord,
     * etc
     */
    public static <T> String listToString(List<T> list, final boolean justValue,
     ...
     * prior to tokenization. This method assumes that this extra information
     * has been encoded in CoreLabel objects for each token of the sentence,
     * which do have the original spacing preserved (done with "invertible=true"
     * for PTBTokenizer). However, the method has loose typing for easier
     * inter-operation with old code that still works with a
     * {@code List<HasWord>}.
     *
     * @param list The sentence (List of tokens) to print out
     * @return The original sentence String, which may contain newlines or other
     * artifacts of spacing
     */
     ...
     * has been encoded in CoreLabel objects for each token of the sentence,
     * which do have the original spacing preserved (done with "invertible=true"
     * for PTBTokenizer). If that information is not there, you will see null
     * outputs, and if you do not pass in a List of CoreLabel objects, then the
     * code will Exception. The method has loose typing for easier
     * inter-operation with old code that still works with a
     * {@code List<HasWord>}.
     *
     * @param list The sentence (List of tokens) to print out
     * @param printBeforeBeforeStart Whether to print the BeforeAnnotation
     * before the first token of the sentence. (In general, the BeforeAnnotation
     * is the same as the AfterAnnotation of the preceding token. So, usually
     * this is correct to do only for the first sentence of a text.)
     * @return The original sentence String, which may contain newlines or other
     * artifacts of spacing
     */
    ...
    /**
     * Returns the substring of the sentence from start (inclusive) to end
     * (exclusive).
     *
     * @param start Leftmost index of the substring
     * @param end Rightmost index of the ngram
     * @return The ngram as a String. Currently returns null if one of the
     * indices is out of bounds. But maybe it should exception instead.
     */
